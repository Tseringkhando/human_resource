...
public class ListFullTimeView extends JPanel{
	ListFullTimeModel model = new ListFullTimeModel();
	//table
	...
	public ListFullTimeView()
	{
		...
		ListFullTimeController c= new ListFullTimeController(this);
		c.viewLists();
		add(getPane());
	...
	public void rowSelected()
	{
		...
		j.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent e)
			{
				...
				setters(reg, firstname, lastname, contact, email, employed,salary,dname);
...
//this sets the text of text fields in  modify section when a row in the table is clicked
	public void setters(String reg, String firstname, String lastname, String contact,String email,String employed,String salary,String dname)
	{
		...
		this.dept.setSelectedItem(dname);
...
//modify sections
	...
	public void addModify(ListFullTimeView v)
	{
		btnModify.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AddFullTimeModel n = new AddFullTimeModel();
				try {
	...
	//delete
	public void delete(ListFullTimeView v)
	{
